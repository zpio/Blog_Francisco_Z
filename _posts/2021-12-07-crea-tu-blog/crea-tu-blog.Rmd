...
**Paso 1: Instalar en Paquete de Distill**
...
Una vez creado el post debe editarlo con tu propio contenido en rmarkdown y ejecutarlo (Knit) para ver como va quedando:
...
Una vez configurado `_site.yml` ejecute (knit) del post si no ha hecho y vuelva a ejecutar **Build Website**:

![](images/15.png)

**Paso 7: Crear el repositorio en Git**

En el menu **Tools** de Rstudio escoja la opcion **Shell** para abrir el cmd (si estamos en windows) ejecutar los comandos de git.
...
En el menu **Tools** de Rstudio escoja la opcion **Shell** para abrir el cmd (si estamos en windows) ejecutar los siguientes comandos de git para subir nuestro proyecto a GitHub:
...
En el menu **Tools** de Rstudio escoja la opcion **Shell** para abrir el cmd (si estamos en windows) ejecutar los siguientes comandos de git para traer el readme del github a nuestra maquina:
