...
conda list env
```
Si ves **`py3.8`** en la lista es porque se creo correctamente.
...
Adicionalmente se puede convertir la consola de rstudio en consola de python. 
...
Cargamos la librerias de Python:
