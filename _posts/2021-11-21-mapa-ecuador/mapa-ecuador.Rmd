---
title: "Mapa del Ecuador con highcharter"
description: |
  Apuntes de graficación del mapa del Ecuador con la libreria highcharter de R.
author:
...
categories:
  ...
  - Highcharter
  - Mapa
preview: images/preview_mapa.png
output: 
...
## Datos del mapa en objeto lista
...
## Datos del mapa en objeto data frame
...
## Data Frame de provincias con sus coordenadas

De `mapa_ec` se extrae las provincias y se crea otro data frame de provincias con sus respectivas coordenadas centroides.
...
## Población 2020 del Ecuador por provincias
...
Hacer un join con las coordenadas de las provincias y la población
...
## Mapa con bubbles degradado por cantidad
